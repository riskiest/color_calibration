...
def test_1(series_tag='A'):
    ...
    test('imgs/input1.png', 6, series_tag, colorspace = AppleRGB, weights_coeff = 2, linear='color_polyfit', deg = 2)
    test('imgs/input1.png', 7, series_tag, colorspace = REC_2020_RGB, distance = 'de94', linear='color_logpolyfit', deg = 3)
