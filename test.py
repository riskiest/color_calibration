...
def test_1(series_tag='A'):
    ...
    test('imgs/input1.png', 3, series_tag, linear='gray_polyfit', ccm_shape = '4x3')
    test('imgs/input1.png', 4, series_tag, distance = 'rgbl', linear='gray_logpolyfit', deg = 3)
    test('imgs/input1.png', 5, series_tag, L=True, linear='identity', distance = 'rgb')
    test('imgs/input1.png', 6, series_tag, weights_coeff = 1, linear='color_polyfit', deg = 2)
    test('imgs/input1.png', 7, series_tag, distance = 'de94', linear='color_logpolyfit', deg = 3)
